...
public class AdlApi {
    ...
    public AdlApi(ApiClient apiClient) {
    ...
    public okhttp3.Call adlRelayPostCall(ADLRelayRequest adLRelayRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = adLRelayRequest;

        // create path and map variables
        String localVarPath = "/adl/relay";
    ...
    private okhttp3.Call adlRelayPostValidateBeforeCall(ADLRelayRequest adLRelayRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'adLRelayRequest' is set
        if (adLRelayRequest == null) {
            throw new ApiException("Missing the required parameter 'adLRelayRequest' when calling adlRelayPost(Async)");
        }

        return adlRelayPostCall(adLRelayRequest, _callback);
