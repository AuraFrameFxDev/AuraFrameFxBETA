...
class ContentResponse(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr
    usage: Optional[ContentResponseUsage] = None
    __properties: ClassVar[List[str]] = ["content", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage": ContentResponseUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
