...
class Theme(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    primary_color: StrictStr = Field(description="Hex color code", alias="primaryColor")
    secondary_color: StrictStr = Field(description="Hex color code", alias="secondaryColor")
    is_default: Optional[StrictBool] = Field(default=None, alias="isDefault")
    __properties: ClassVar[List[str]] = ["id", "name", "primaryColor", "secondaryColor", "isDefault"]
